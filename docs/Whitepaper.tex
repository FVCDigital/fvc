...
\title{DeFi's First Venture Capital Token - \$FVC}
...
\textbf{Ecosystem Development (20.0\%)}

\begin{itemize}
\tightlist
\item
  \textbf{Allocation:} 200,000,000 FVC tokens
\item
  \textbf{Purpose:} Exchange listings, FVC developer grants, protocol integrations, and strategic partnerships
\item
  \textbf{Control:} Multi-signature safe wallet with governance oversight
\item
  \textbf{Note:} Dedicated to ecosystem expansion and developer incentive programmes
\end{itemize}

\textbf{Protocol Reserve (7.0\%)}

\begin{itemize}
\tightlist
\item
  \textbf{Allocation:} 70,000,000 FVC tokens
\item
  \textbf{Purpose:} Long-term operational flexibility and future initiatives
\item
  \textbf{Control:} Governance-controlled deployment requiring community approval
\item
  \textbf{Note:} Strategic reserve for unforeseen opportunities and operational needs
\end{itemize}

\textbf{Security Reserve (7.0\%)}
...
\item
  \textbf{Allocation:} 70,000,000 FVC tokens
\item
  \textbf{Purpose:} Emergency security fund, bug bounties, audits, and incident response
\item
  \textbf{Governance:} Subject to community governance approval for deployment
\item
  \textbf{Note:} Enhanced reserve for protocol protection and security operations
\end{itemize}

\textbf{Buy \& Burn Reserve (3.0\%)}

\begin{itemize}
\tightlist
\item
  \textbf{Allocation:} 30,000,000 FVC tokens
\item
  \textbf{Purpose:} Market support mechanism through token burns
\item
  \textbf{Control:} Executed via multi-signature safe using treasury revenues
\item
  \textbf{Note:} Dedicated allocation for price support without minting new supply
\end{itemize}
...
on compliant venture funding. It operates on Binance Smart Chain and other Ethereum-compatible
