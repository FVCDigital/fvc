{{--
  resources/views/layouts/shadstrap.blade.php

  A Laravel Blade layout wired for the "Shadstrap" theme (Bootstrap 5 with shadcn/ui aesthetics).
  Source: https://www.cssscript.com/bootstrap-shadcn-ui-theme/

  How to use:
  1) Download the Shadstrap CSS from the article (or repo) and place it at `public/css/shadstrap.min.css`.
     - Alternatively, host it via your own CDN and change the <link> below accordingly.
  2) In your Blade views, extend this layout:
        @extends('layouts.shadstrap')
        @section('title', 'Welcome')
        @section('content')
            <h1 class="h3 mb-4">Hello from Shadstrap + Bootstrap</h1>
            {{-- Your content here --}}
        @endsection
  3) (Optional) Use the built-in theme toggle in the navbar to switch between light/dark.
--}}
