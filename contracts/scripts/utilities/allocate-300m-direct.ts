...
async function main() {
  console.log("🔧 Directly Allocating 300M FVC to Bonding...");
  ...
  console.log("\n🚀 Direct Mint to Bonding...");

  try {
    // Directly mint to bonding contract
    console.log("Minting", ethers.formatEther(additionalNeeded), "FVC directly to bonding...");
    const mintTx = await fvc.mint(BONDING_ADDRESS, additionalNeeded);
    console.log("Mint transaction hash:", mintTx.hash);
    await mintTx.wait();
    console.log("✅ FVC minted directly to bonding!");
