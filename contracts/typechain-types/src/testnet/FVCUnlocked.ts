...
export interface FVCUnlockedInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface FVCUnlocked extends BaseContract {
  connect(runner?: ContractRunner | null): FVCUnlocked;
  waitForDeployment(): Promise<this>;

  interface: FVCUnlockedInterface;
