...
export interface MockFVCInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "MINTER_ROLE"
...
export interface MockFVC extends BaseContract {
  connect(runner?: ContractRunner | null): MockFVC;
  waitForDeployment(): Promise<this>;

  interface: MockFVCInterface;
