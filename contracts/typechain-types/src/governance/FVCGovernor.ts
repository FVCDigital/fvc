...
export interface FVCGovernorInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BALLOT_TYPEHASH"
      | "CLOCK_MODE"
...
export namespace GovernanceParametersUpdatedEvent {
  export type InputTuple = [
...
export interface FVCGovernor extends BaseContract {
  connect(runner?: ContractRunner | null): FVCGovernor;
  waitForDeployment(): Promise<this>;

  interface: FVCGovernorInterface;
  ...
  initialize: TypedContractMethod<
    [_token: AddressLike, _timelock: AddressLike, _admin: AddressLike],
    [void],
    "nonpayable"
  >;
  ...
  updateQuorumFraction: TypedContractMethod<
    [newQuorumFraction: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "updateQuorumFraction"
  ): TypedContractMethod<
    [newQuorumFraction: BigNumberish],
    [void],
    "nonpayable"
  ...
  >;
  getEvent(
    key: "GovernanceParametersUpdated"
  ): TypedContractEvent<
    GovernanceParametersUpdatedEvent.InputTuple,
    GovernanceParametersUpdatedEvent.OutputTuple,
    GovernanceParametersUpdatedEvent.OutputObject
  >;
  getEvent(
    key: "Initialized"
  ): TypedContractEvent<
  ...
  filters: {
    ...
    "GovernanceParametersUpdated(uint256,uint256,uint256)": TypedContractEvent<
      GovernanceParametersUpdatedEvent.InputTuple,
      GovernanceParametersUpdatedEvent.OutputTuple,
      GovernanceParametersUpdatedEvent.OutputObject
    >;
    GovernanceParametersUpdated: TypedContractEvent<
      GovernanceParametersUpdatedEvent.InputTuple,
      GovernanceParametersUpdatedEvent.OutputTuple,
      GovernanceParametersUpdatedEvent.OutputObject
    >;
