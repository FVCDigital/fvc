...
export interface GovernorTimelockControlUpgradeableInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BALLOT_TYPEHASH"
      | "CLOCK_MODE"
...
export interface GovernorTimelockControlUpgradeable extends BaseContract {
  connect(runner?: ContractRunner | null): GovernorTimelockControlUpgradeable;
  waitForDeployment(): Promise<this>;

  interface: GovernorTimelockControlUpgradeableInterface;
